...
public class ConnectionConfig {
	...
	public static String WEBCAM_SERVER_HOST		= "127.0.0.1";
	public static String DESKTOP_SERVER_HOST	= "127.0.0.1";
	
	public static void setWebcamServerHost(String host) {
		WEBCAM_SERVER_HOST = host;
	}
	
	public static void setDesktopServerHost(String host) {
